...
sap.ca.scfld.md.controller.ScfldMasterController.extend("ui.s2p.mm.purchorder.approve.view.S2", {
		...
		oList.attachEvent("updateFinished", function(oEvent) {			
			if (!sap.ui.Device.system.phone) {
				if(!this.aNextItems){
					...
					if(!this.findItemByContextPath(this.aNextItems[0].getBindingContextPath())){					
						var bFound = false;
	...
	_getODataSearchFields : function() {
		var aODataSearchFields = [ "CreatedByName", "ForwardedByName", "ItemDescriptions", "PoNumber", "PoNumberFormatted", "SearchForText", "SubstitutingForName", "SupplierID", "SupplierName", "WiCreatedAt", "WorkitemID" ];
		/**
